...
def get_commits(request):
    ...
    if bool(Commit.objects.filter(repository__repositoryID=repo.id)):
        ...
        date1c = Commit.objects.filter(repository__repositoryID=repo.id, date__month=1, state='closed')
        date2c = Commit.objects.filter(repository__repositoryID=repo.id, date__month=2, state='closed')
        date3c = Commit.objects.filter(repository__repositoryID=repo.id, date__month=3, state='closed')
        date4c = Commit.objects.filter(repository__repositoryID=repo.id, date__month=4, state='closed')
        date5c = Commit.objects.filter(repository__repositoryID=repo.id, date__month=5, state='closed')
        date6c = Commit.objects.filter(repository__repositoryID=repo.id, date__month=6, state='closed')
        date7c = Commit.objects.filter(repository__repositoryID=repo.id, date__month=7, state='closed')
        date8c = Commit.objects.filter(repository__repositoryID=repo.id, date__month=8, state='closed')
        date9c = Commit.objects.filter(repository__repositoryID=repo.id, date__month=9, state='closed')
        date10c = Commit.objects.filter(repository__repositoryID=repo.id, date__month=10, state='closed')
        date11c = Commit.objects.filter(repository__repositoryID=repo.id, date__month=11, state='closed')
        date12c = Commit.objects.filter(repository__repositoryID=repo.id, date__month=12, state='closed')
